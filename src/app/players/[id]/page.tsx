...
import { currentUz1Sporting, PlayerSportingCard } from "@/components/player-sporting-card";
import "./detail.css";
...
export default async function PlayerDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const currentUz1Performance = currentUz1Sporting(p.performances);
